        ...
        <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-500">
                    Kelola organisasi, pelatihan, dan pencapaian yang tampil pada portfolio.
                </p>
            </div>
                    ...
                    @foreach($experiences as $experience)
                        ...
                        <div class="flex flex-col gap-5 p-5 md:flex-row md:items-center md:justify-between">
                                ...
                                @if($experience->tanggal_mulai || $experience->tanggal_selesai)
                                    ...
                                    <p class="mt-2 text-xs text-gray-400">
                                        ...
                                        @if($experience->tanggal_mulai)
                                            {{ $experience->tanggal_mulai->format('d M Y') }}
                                        @endif
                                        ...
                                        @if($experience->tanggal_selesai)
                                            {{ $experience->tanggal_selesai->format('d M Y') }}
                                        @endif
                            ...
                            <div class="flex shrink-0 flex-wrap gap-2">
                                ...
                                {{-- Toggle --}}
                                <form
                                    action="{{ route('admin.experiences.toggle-status', $experience) }}"
                                    method="POST">
                                    ...
                                    <button
                                        ...
                                        {{ $experience->status ? 'Nonaktifkan' : 'Aktifkan' }}
                                    </button>
            ...
            @else
                ...
                <div class="px-6 py-16 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Tambahkan organisasi, pelatihan, atau pencapaian pertama kamu.
                    </p>
