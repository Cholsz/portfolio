...
<head>
    ...
    <title>Edit Pengalaman - Admin</title>
    ...
    <main class="mx-auto max-w-3xl px-6 py-10">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-500">
                Perbarui informasi organisasi, pelatihan, atau pencapaian.
            </p>
        ...
        <form
            ...
            <div class="mb-5">
                ...
                <select
                    ...
                    <option
                        value="organisasi"
                        {{ old('type', $experience->type) === 'organisasi' ? 'selected' : '' }}>
                        Organisasi
                    </option>

                    <option
                        value="pelatihan"
                        {{ old('type', $experience->type) === 'pelatihan' ? 'selected' : '' }}>
                        Pelatihan
                    </option>

                    <option
                        value="pencapaian"
                        {{ old('type', $experience->type) === 'pencapaian' ? 'selected' : '' }}>
                        Pencapaian
                    </option>
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    id="judul"
                    name="judul"
                    value="{{ old('judul', $experience->judul) }}"
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    id="institusi"
                    name="institusi"
                    value="{{ old('institusi', $experience->institusi) }}"
            ...
            <div class="mb-5">
                ...
                <textarea
                    ...
                    class="textarea textarea-bordered w-full">{{ old('deskripsi', $experience->deskripsi) }}</textarea>
            ...
            <div class="mb-5 grid gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="tanggal_mulai"
                        name="tanggal_mulai"
                        value="{{ old('tanggal_mulai', $experience->tanggal_mulai?->format('Y-m-d')) }}"
                        class="input input-bordered w-full">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('tanggal_selesai', $experience->tanggal_selesai?->format('Y-m-d')) }}"
                        class="input input-bordered w-full">
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    id="gambar"
                    name="gambar"
                    value="{{ old('gambar', $experience->gambar) }}"
                    placeholder="Contoh: organisasi.jpg"
                    class="input input-bordered w-full">

                <p class="mt-2 text-xs text-gray-400">
                    Untuk sementara masukkan nama/path gambar.
                </p>
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    id="urutan"
                    name="urutan"
                    value="{{ old('urutan', $experience->urutan) }}"
                    min="0"
                    class="input input-bordered w-full">
            ...
            <div class="mb-8">
                ...
                <label class="flex cursor-pointer items-center gap-3">
                    ...
                    <input
                        ...
                        {{ old('status', $experience->status) ? 'checked' : '' }}>
